...
| :--- | :--- | :--- |
| **Java Edition** | `mc.gillyb.net` | Default (25565) |
| **Bedrock Edition** | `mc.gillyb.net` | `19132` |
...
If you need help getting whitelisted or have any questions, please join our Discord server:
...
*Ensure that you read the [Server Rules](./rules.md) before joining!*
