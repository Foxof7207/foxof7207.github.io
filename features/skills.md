...
| **Enchanting** | Enchant items and use bottles. | Mana & Wisdom |
...
| **Swift Edge** | Increases movement speed after dealing damage. |
| **Frostbite** | Slows enemies and grants resistance on hit. |
| **Lifesteal** | Heals you for a portion of damage dealt. |
